...
#define SPEED_CAMERA_MOVE 0.5
#define SPEED_CAMERA_ROTATE 0.0015
#define SPEED_CAMERA_ZOOM 2.0
#define SPEED_CAR_MOVE 0.48
#define SPEED_CAR_ROTATE 0.05
...
#define PATH_MODEL_GROUND "assets/models/ground_plane.obj"
